...
<form action="MainServlet" method="post" >
	<input type="hidden" name="command" value="Write_list"> <input
		type=hidden name="num" value="${category.num }"> <input
		type="hidden" name="username" value="${loginuser.name }">
		...
		<div id="page-content-wrapper">
			...
			<div class="content-wrapper clearfix">
				...
				<textarea class="content-textarea form-control"
					placeholder="내용을 입력해주세요." name="content" style="width: 100%; padding-right: 320px;"
					readonly="readonly">${category.content }
					</textarea>
					<c:choose>
						<c:when test="${empty category.image }">
							<img src="Image/Logo.jpeg" style="width: 300px; height: 280px; position: absolute; bottom: 10px; right: 10px; object-fit: contain">
						</c:when>
						<c:otherwise>
							<img src="upload/${category.image }" style="width: 300px; height: 280px; position: absolute; bottom: 10px; right: 10px; object-fit: contain">
						</c:otherwise>
