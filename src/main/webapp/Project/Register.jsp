...
<body>
	<form action="MainServlet?command=Register_list" method="post">
				...
				<div class="tab-content">
					<ul class="nav nav-pills nav-justified mb-3" id="ex1"
						...
						<li class="nav-item" role="presentation" style="flex-grow: 0;"><a class="nav-link "
							...
							href="MainServlet?command=login_list_form" role="tab"
						...
						<li class="nav-item" role="presentation" style="flex-grow: 0;"><a
							...
							href="MainServlet?command=Register_list_form" role="tab"
							aria-controls="pills-register" aria-selected="false">회원가입</a></li>
					</ul>
					<div class="form-outline mb-4"
						...
						<label style="display: flex; align-items: center"> <span
							style="width: 90px;">ID :</span> <input type="text"
							id="loginName" name="userid" class="form-control"
							placeholder="username or id" style="margin: 0 !important;" />
						</label>
					</div>
					...
					<div class="form-outline mb-4"
						style="display: flex; align-items: center; justify-content: center; padding-top: 20px">
						<label style="display: flex; align-items: center"> <span
							style="width: 90px;">Password :</span> <input name="password"
							type="password" id="loginPassword" class="form-control"
							placeholder="your password" style="margin: 0 !important;" />
						</label>
					</div>
					<div class="form-outline mb-4"
						style="display: flex; align-items: center; justify-content: center; padding-top: 20px">
						<label style="display: flex; align-items: center"> <span
							style="width: 90px;">Nickname :</span> <input name="name" type="text"
							id="loginPassword" class="form-control" placeholder="your name"
					...
					<input type="submit" class="btn btn-dark btn-block mb-4"
						value="가입" style="display: block; margin: 0 auto;"></input>
